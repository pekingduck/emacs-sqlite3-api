...
defconst(env, "sqlite-scanstat-nloop", env->make_integer(env, SQLITE_SCANSTAT_NLOOP));
defconst(env, "sqlite-scanstat-nvisit", env->make_integer(env, SQLITE_SCANSTAT_NVISIT));
defconst(env, "sqlite-scanstat-est", env->make_integer(env, SQLITE_SCANSTAT_EST));
defconst(env, "sqlite-scanstat-name", env->make_integer(env, SQLITE_SCANSTAT_NAME));
defconst(env, "sqlite-scanstat-explain", env->make_integer(env, SQLITE_SCANSTAT_EXPLAIN));
defconst(env, "sqlite-scanstat-selectid", env->make_integer(env, SQLITE_SCANSTAT_SELECTID));
